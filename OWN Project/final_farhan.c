                                ...
                                case 3:
                                    {
                                        ...
                                        for(i=0; i<3; i++)
                                        {
                                            ...
                                            {
                                                printf("\nYour amount for payment is BDT %lf.\n", sclub[i].fee);
                                                int confirmClubPay;
                                                printf("\nPress 1 to pay your club fee or press 0 to exit!\n");
                                                scanf("%d",&confirmClubPay);
                                                if(confirmClubPay==1)
...
double tutionFee(double *balance,double credit)
{
    ...
    printf("\nYour tuition for the semester is %.2lf:\n",tutionFeeAmount);
    int confirmTransact;
    if(*balance>tutionFeeAmount)
    {
        ...
        if(confirmTransact==1)
        {
            *balance-=tutionFeeAmount;
            printf("Transaction Successful! Your tuition fee: %.2lf taka has been paid.\n",tutionFeeAmount);
        }
    }
    else
    {
